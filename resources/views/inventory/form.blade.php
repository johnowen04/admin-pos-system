        ...
        <div class="card-body">
            <div class="row-md-4">
                ...
                <div class="form-group">
                    ...
                    <select class="form-select form-control" id="productCategory" name="categories_id">
                    ...
                    <div class="d-flex">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="is_shown" value="1"
                                ...
                                {{ old('is_shown', $product->is_shown ?? 1) == 1 ? 'checked' : '' }} />
                        ...
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="is_shown" value="0"
                                ...
                                {{ old('is_shown', $product->is_shown ?? 1) == 0 ? 'checked' : '' }} />
            ...
            <div class="row">
                <div class="col-md-2 col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-select form-control" id="productUnit" name="units_id">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="productConversion" placeholder="0" disabled
                            value="{{ old('conversion_unit', $product->unit->conversion_unit ?? '') }}" />
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="number" class="form-control" id="productSellPrice" placeholder="0" name="sell_price"
                ...
                <div class="col-md-2 col-lg-6">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            <input type="number" class="form-control" id="productMinOrder" placeholder="Ex: 1, 2, 3" name="min_qty"
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="number" class="form-control" id="productBuyPrice" placeholder="0" name="buy_price"
