<div>
    @if ($report->rows()->isEmpty())
        <div class="empty-state text-center py-5">
            ...
            <p class="text-muted">
                There are no category sales records to display in the selected period.
    ...
    @else
        <div class="d-flex flex-column flex-xl-row mb-3 gap-3 align-items-end">
            ...
            <div style="width: 150px;">
                ...
                <select id="categoryPerPage" wire:model="perPage" wire:change="resetPage" class="form-select">
        ...
        <div class="table-responsive">
            <table class="table table-striped table-hover">
                <thead>
                    <tr>
                        <th wire:click="sortBy('c.name')" style="cursor: pointer">
                ...
                <tbody>
                    @forelse ($report->rows() as $category)
                        <tr>
                            <td>{{ $category['name'] }}</td>
