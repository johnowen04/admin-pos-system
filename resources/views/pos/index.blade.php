    ...
    <div class="page-inner">
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <div id="productGrid" class="row g-2" style="min-height: 60vh; max-height: 350px; overflow-y: auto;">
                    @foreach ($products as $product)
                        <div class="col-6 col-md-4 col-lg-3 product-item" data-name="{{ $product->name }}"
                            ...
                            <div class="border p-3 text-center rounded bg-light">
                                ...
                                <div class="text-muted">Rp {{ number_format($product->sell_price, 0, ',', '.') }}</div>
            ...
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-body">
                        <ul id="cartItems" class="list-group mb-3" style="min-height: 60vh; max-height: 350px; overflow-y: auto;">
                            <!-- Example cart item -->
